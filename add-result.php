...
mysqli_query($GLOBALS["___mysqli_ston"],"INSERT INTO tblsession(SchoolSession,InTerm,StudentId,ClassId,StudentPosition) VALUES ('$sn', '$tm', '$studentid','$class','$ps')");
/* for inserting into tblsession */
...
function getresult(val,clid,tr,ss) 
{   
 ...
 <strong>Well done!</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
									...
									<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                    <input type="text" class="form-control ssid" id="session" value="2018/2019" autocomplete="off" name="session">
                                                        </div>
                                                    </div>
													...
													<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                    <select name="term" class="form-control trid" id="term" required="required">
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Position</label>
                                                        <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="position" placeholder="2nd" autocomplete="off" name="position">
                                                        </div>
                                                    </div>
