...
$id2=$dta[2];
$id3=$dta[3];
 $query = $dbh->prepare("SELECT StudentId,ClassId,InTerm,SchoolSession FROM tblsession WHERE StudentId=:id1 and ClassId=:id and InTerm=:trid and SchoolSession=:ssid ");
//$query= $dbh -> prepare($sql);
$query-> bindParam(':id1', $id1, PDO::PARAM_STR);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query-> bindParam(':ssid', $id3, PDO::PARAM_STR);
$query-> bindParam(':trid', $id2, PDO::PARAM_STR);
$query-> execute();
